  ...
  <body>
    ...
    <div class="content" id="jenis_payung" style="padding-top:100px;">
      ...
      <!-- <div class="pembungkus-dp">
        <div class="gambar">
          <img src="img/standar/payungstandar5.jpg" alt="">
        </div>
        <div class="text-dp">
      ...
      <div class="gallery">
        ...
        <div class="row">
        <div class="col">
          <img src="img/payung_terbalik/payung_terbalik5.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/payung_terbalik/payung_terbalik6.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/payung_terbalik/payung_terbalik3.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/payung_terbalik/payung_terbalik4.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/payung_terbalik/payung_terbalik2.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/payung_terbalik/payung_terbalik1.jpg" alt="" class="center">
        </div>
