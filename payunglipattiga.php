  ...
  <body>
    ...
    <div class="content" id="jenis_payung" style="padding-top:100px;">
      ...
      <!-- <div class="pembungkus-dp">
        <div class="gambar">
          <img src="img/lipat_tiga/lipattiga1-01.jpg" alt="">
        </div>
        <div class="text-dp">
      ...
      <div class="gallery">
        ...
        <div class="row">
        <div class="col">
          <img src="img/lipat_tiga/lipattiga1-01.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/lipat_tiga/lipattiga2-01.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/lipat_tiga/lipattiga3-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga5-01.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/lipat_tiga/lipattiga6-01.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/lipat_tiga/lipattiga7-01.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/lipat_tiga/lipattiga8-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga9-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga10-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga12-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga13-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga14-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga15-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga16-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga17-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga18-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga19-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga20-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga21-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga22-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga23-01.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/lipat_tiga/lipattiga24-01.jpg" alt="">
        </div>
        </div>
        <div class="button-pesan">
