  ...
  <body>
    ...
    <div class="content" id="jenis_payung" style="padding-top:100px;">
      ...
      <div class="gallery">
        ...
        <div class="row">
        <div class="col">
          <img src="img/botol/botol-01.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/botol/botol-02.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/botol/botol-03.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/botol/botol-04.jpg" alt="" class="center">
        </div>
