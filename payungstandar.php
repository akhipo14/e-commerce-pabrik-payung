  ...
  <body>
    ...
    <div class="content" id="jenis_payung" style="padding-top:100px;">
      ...
      <div class="gallery">
        ...
        <div class="row">
        <div class="col">
          <img src="img/standar/payungstandar5.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/standar/payungstandar6.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/standar/payungstandar7.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/standar/payungstandar1.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/standar/payungstandar2.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/standar/payungstandar3.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/standar/payungstandar4.jpg" alt="">
        </div>
        </div>
        <div class="button-pesan">
