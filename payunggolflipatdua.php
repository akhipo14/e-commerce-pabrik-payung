  ...
  <body>
    ...
    <div class="content" id="jenis_payung" style="padding-top:100px;">
      ...
      <!-- <div class="pembungkus-dp">
        <div class="gambar">
          <img src="img/golf_lipat_2/lipatdua1.jpg" alt="">
        </div>
        <div class="text-dp">
      ...
      <div class="gallery">
        ...
        <div class="row">
        <div class="col">
          <img src="img/golf_lipat_2/lipatdua1.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/golf_lipat_2/lipatdua3.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/golf_lipat_2/lipatdua4.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/golf_lipat_2/lipatdua5.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/golf_lipat_2/lipatdua6.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/golf_lipat_2/lipatdua7.jpg" alt="">
        </div>
        </div>
        <div class="button-pesan">
