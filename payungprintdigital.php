  ...
  <body>
    ...
    <div class="content" id="jenis_payung" style="padding-top:100px;">
      ...
      <div class="gallery">
        ...
        <div class="row">
        <div class="col">
          <img src="img/print_digital/payungprintgidital1.jpg" alt="" class="center">
        </div>
        <div class="col">
          <img src="img/print_digital/payungprintgidital2.jpg" alt="">
        </div>
        <div class="col">
          <img src="img/print_digital/payungprintgidital3.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/print_digital/payungprintgidital4.jpg" alt="">
        </div>
				<div class="col">
          <img src="img/print_digital/payungprintgidital5.jpg" alt="">
        </div>
        </div>
        <div class="button-pesan">
